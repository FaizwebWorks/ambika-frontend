const ProductCard = ({ product, isLoggedIn }) => (
  <div className="bg-white rounded-lg overflow-hidden border border-neutral-100 transition-all duration-300 flex flex-col">
    ...
    <div className="p-5 flex flex-col flex-grow">
      <h3 className="font-medium text-neutral-800 mb-2 line-clamp-2 min-h-[48px]">
        {product.name}
      </h3>
